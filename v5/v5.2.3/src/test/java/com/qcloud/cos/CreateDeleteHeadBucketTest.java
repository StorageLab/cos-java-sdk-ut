...
public class CreateDeleteHeadBucketTest extends AbstractCOSClientTest {
    ...
    public void testCreateDeleteBucketPublicRead() throws Exception {
        ...
        try {
            String bucketName = String.format("pubrw523%d-1251668577", System.currentTimeMillis() / 1000);
    ...
    public void testCreateDeleteBucketPublicReadWrite() throws Exception {
        ...
        try {
            String bucketName = String.format("pubr523%d-1251668577", System.currentTimeMillis() / 1000);
            CreateBucketRequest createBucketRequest = new CreateBucketRequest(bucketName);
    ...
    public void testCreateDeleteBucketPrivate() throws Exception {
        ...
        try {
            String bucketName = String.format("pri523%d-1251668577", System.currentTimeMillis() / 1000);
            CreateBucketRequest createBucketRequest = new CreateBucketRequest(bucketName);
