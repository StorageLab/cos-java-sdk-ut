...
@SuiteClasses({AclTest.class, BatchDeleteTest.class, BucketReplicationTest.class,
        ...
        SymmetricCOSEncryptionClientWithObjectMetaCryptoModeTest.class,
        SymmetricCOSEncryptionClientWithInstructionCryptoModeTest.class,
        ASymmetricCOSEncryptionClientWithObjectMetadataCryptoModeTest.class,
        ASymmetricCOSEncryptionClientWithInstructionCryptoModeTest.class})
